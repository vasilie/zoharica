...
<div id="content">		
	...
	<div id="glavno">				
		...
		//-------------- Konekcija SQL, uzima informacije iz smradovi, i ubacuje u  promenljive--------------------
		...
		// Ako ip adresa postoji u fajlu 'adresa.txt' $glasanje je false
				...
				*/
						...
						switch ($zohari)
							{
								case "nesica":
											...
											$nesica++;
									  		mysql_query("UPDATE smradovi SET poeni='$nesica' WHERE id='1'");
									  		$lik="Nešicu";
									break;
								...
								case "dzoni":
									  		...
									  		$dzoni++;
									  		mysql_query("UPDATE smradovi SET poeni='$dzoni' WHERE id='4'");
									  		$lik="Džonija";
									break;
								...
								case "vasilie":
									  		...
									  		$vasilie++;
									  		mysql_query("UPDATE smradovi SET poeni='$vasilie' WHERE id='3'");
									  		$lik="Vasilia";
									break;	  
			  					...
			  					case "joca":
									  		...
									  		$joca++;
									  		mysql_query("UPDATE smradovi SET poeni='$joca' WHERE id='2'");
									  		$lik="Jocu";
									break;
								...
								case "manu":
								  			...
								  			$manu++;
								  			mysql_query("UPDATE smradovi SET poeni='$manu' WHERE id='5'");
								  			$lik="Manua";
								break;
								...
								case "esteban":
								  			...
								  			$esteban++;
								  			mysql_query("UPDATE smradovi SET poeni='$esteban' WHERE id='6'");
								  			$lik="Estebana";
								break;
								...
								case "adam":
								  			...
								  			$adam++;
								  			mysql_query("UPDATE smradovi SET poeni='$adam' WHERE id='7'");
								  			$lik="Adama";
								break;
							...
							$vremeglasanja=time("H:i:s");
							$vr = "$vremeglasanja";
							if (isset($_COOKIE['username'])){
								mysql_query("UPDATE vremeg SET vreme='$vr' WHERE id='1'");
								mysql_query("UPDATE glasao SET ime='$poslednji' WHERE id='1'");
							}
				...
				echo $pozdrav;
				$vreme=date('H');
				$result1 = mysql_query("SELECT * FROM vreme WHERE id=1 LIMIT 1");
		...
		<div id="glasao">
			<p style="margin-bottom:4px;">Poslednji je glasao:<span class="boja"> 
				<?php 
					...
					$result2 = mysql_query("SELECT * FROM glasao WHERE id=1 LIMIT 1");
					$row2 = mysql_fetch_assoc($result2);
					$SQLposlednji = $row2['ime'];
					$result3 = mysql_query("SELECT * FROM vremeg WHERE id=1 LIMIT 1");
